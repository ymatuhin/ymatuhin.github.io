...
Я рекомендую использовать этот способ форумам, сайтам и порталам для пиксельной графики. Что касается Edge и оперы, то генерируйте изображения и анимации большого размера, чтобы даже если сглаживание работает, пользователям было хорошо видно.
